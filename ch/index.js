  ...
  var buttonContainer6 = document.getElementById("readMoreProjects");
  if (buttonContainer6) {
    buttonContainer6.addEventListener("click", function (e) {
      window.location.href = "./ai-projects.html";
    });
  }
  ...
  var buttonContainer5 = document.getElementById(
    "buttonContainerGenealogy"
  );
  if (buttonContainer5) {
    buttonContainer5.addEventListener("click", function (e) {
  ...
  var singleItemContainer5 = document.getElementById(
    "singleItemContainer5"
  );
  if (singleItemContainer5) {
    singleItemContainer5.addEventListener("click", function (e) {
      window.location.href = "./ai-data-services.html";
    });
  }
